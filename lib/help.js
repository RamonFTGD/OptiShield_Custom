...
export function generateCategoryMenu(commandsMap, prefix = '.', filterCategory = null) {
  ...
  // Header
  lines.push(`┏━━━━━━━━━━━━━━━━━━━━━━━━┓`)
  lines.push(`┃     🛡️  *OPTISHIELD CUSTOM*      ┃`)
  lines.push(`┣━━━━━━━━━━━━━━━━━━━━━━━━┫`)
  lines.push(`┃  ${filterCategory ? `📂 ${filterCategory.toUpperCase()}` : '📋 MENÚ DE COMANDOS'}  ┃`)
  lines.push(`┃  ✨ Total: ${totalCmds} comandos  ┃`)
  lines.push(`┗━━━━━━━━━━━━━━━━━━━━━━━━┛`)
  lines.push(``)

  for (const [category, cmds] of sortedCats) {
    const catConfig = CATEGORIES[category] || { emoji: '📦', name: category }
    lines.push(`╔═══ 「 ${catConfig.emoji} *${catConfig.name.toUpperCase()}* 」`)
  ...
  if (!filterCategory) {
    lines.push(`┍━━━━━━━━━━━━━━━━━━━━━━━━┑`)
    lines.push(`│ 💡 *TIPS DE USO*`)
    lines.push(`│ • ${prefix}menu <categoría>`)
    lines.push(`│ • ${prefix}help <comando>`)
    lines.push(`│ • ${prefix}lid (mi info)`)
    lines.push(`┕━━━━━━━━━━━━━━━━━━━━━━━━┙`)
    lines.push(``)
    lines.push(`⭐ *OptiShield Custom v3.0*`)
  } else {
    lines.push(`✨ _Escribe *${prefix}menu* para volver_`)
  }
